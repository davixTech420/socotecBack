...
const validationSchemas = {
    ...
    email: body('email')
        ...
        .isEmail()
        .withMessage('Debe proporcionar un correo electrónico válido.'),
        salario: body('salario').notEmpty().isFloat().withMessage("El Salario solo pueden ser numeros"),
        cargo: body('cargo').notEmpty().withMessage("El Cargo no puede estar vacio"),
        tipoContrato: body('tipoContrato').notEmpty().withMessage("El tipo de contrato no puede estar vacio"),
        estado: body('estado').notEmpty().withMessage("El estado no puede estar vacio"),
